...
iPostEffectType::iPostEffectType(const tString &asName, cGraphics *apGraphics,
                                 cResources *apResources)
    : mpGraphics(apGraphics), mpResources(apResources), msName(asName) {}

iPostEffectType::~iPostEffectType() {}

//-----------------------------------------------------------------------

iPostEffect::iPostEffect(cGraphics *apGraphics, cResources *apResources,
                         iPostEffectType *apType)
    : mpGraphics(apGraphics), mpResources(apResources), mpType(apType),
      mbDisabled(false), mbActive(true) {}
